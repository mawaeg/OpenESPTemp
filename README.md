...
Those libraries are stored under [/electronics/lib/](/electronics/libs/).

The libraries are licensed under their respective license. Please be aware of the `README.md` and speicifc LICENSE files in the lib folders.
